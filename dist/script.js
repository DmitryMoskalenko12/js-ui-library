...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.addAttribute = function (attributeName, value) {
  for (let i = 0; i < this.length; i++) {
    if (!attributeName) {
      return this;
    }
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.showAttribute = function (attributeName) {
  for (let i = 0; i < this.length; i++) {
...
/* console.log($('.some').closest('.findmed').addClass('fdff')) */
